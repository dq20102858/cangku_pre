    ...
    <div class="app-page">
      ...
      <div class="app-table app-table-nowrap">
        ...
        >
          ...
          <el-table-column prop="username" label="物品编号"></el-table-column>
          <el-table-column prop="role" label="物品名称"></el-table-column>
          <el-table-column prop="role" label="物品规格"></el-table-column>
          <el-table-column prop="role" label="物品数量"></el-table-column>
          <el-table-column prop="role" label="存放位置"></el-table-column>
